# $2^4:S_4$ as a subgroup of the McLaughlin group McL
...
$$
    H=\langle a,c,d,e,f\rangle \cong 2^4:S_4,
$$

then

$$
    [\mathrm{McL}:H]=2,338,875.
$$
...
The recorded run took about 18.6 seconds.
...
??? info "Truncated output from the Python script"
    ...
    #0: ToddCoxeter: time spent in phases |          - (0%) |             - (0%) |            - (0%) | 18.562s (100%)
    #0: ToddCoxeter: phase 0.1 = 18.572s  | run 0 = 18.572s | all runs = 18.572s | elapsed = 18.572s
    The index of the subgroup is 2338875
    ```
