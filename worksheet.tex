...
\begin{enumerate}
  \item Let $J_n$ denote the Jones monoid of degree $n$, and
    ...
    \begin{enumerate}
      ...
      \item How many idempotent elements $e$, for which $7$ is in the
        domain of $e$, does the Green's $\mathcal{D}$-class of $x$ in
        $J_{14}$ contain?
  ...
  \item
    ...
    \[
      \langle a, b, c, d, e, f, g \mid abcd = aaaeaa, ef= dg\rangle.
    \]
    \begin{enumerate}
      \item
  ...
  \item
    Is the semigroup defined by the presentation
    \[
  ...
  \item
    ...
    \begin{align*}
      ...
      \rangle
    \end{align*}
    What is the minimal set of the relations in this presentation
    that define the same monoid?
    % TODO add citation
